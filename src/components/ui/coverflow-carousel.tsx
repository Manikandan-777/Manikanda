        ...
        {showNavigation && (
          <>
            <button
              ...
              onClick={() => nudge(-1)}
              className="absolute left-3 top-1/2 z-[200] -translate-y-1/2 rounded-full bg-background/80 p-2.5 text-foreground backdrop-blur transition hover:bg-background"
            >
            ...
            <button
              ...
              onClick={() => nudge(1)}
              className="absolute right-3 top-1/2 z-[200] -translate-y-1/2 rounded-full bg-background/80 p-2.5 text-foreground backdrop-blur transition hover:bg-background"
            >
        ...
        <div className="mt-5 flex flex-wrap items-center justify-center gap-0.5">
          {slides.map((_, index) => (
            <button
              ...
              onClick={() => goTo(index)}
              // generous tap area, small visible dot
