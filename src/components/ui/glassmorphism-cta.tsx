...
export default function GlassmorphismCta({
  ...
  return (
    <a
      ...
      className={cn(
        // glow recoloured from indigo to the site's code-green accent
        "group isolate inline-flex cursor-pointer overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_8px_rgba(18,161,80,0.35)] rounded-full relative shadow-[0_8px_40px_rgba(18,161,80,0.25)]",
        className,
      )}
      style={
        {
    ...
    >
      <div className="absolute inset-0">
        <div
          data-shimmer
          className="absolute inset-[-200%] w-[400%] h-[400%] [animation:rotate-gradient_var(--speed)_linear_infinite]"
        >
      ...
      >
        ...
        <div
          ...
          style={{
            inset: "1px",
            // inner surface matched to the site's dark green-black
